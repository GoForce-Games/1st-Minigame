...
int main()
{
    ...
    do
    {
        do
        {
            ...
            cout << "Jugador " << jugador << ", escoge la casilla (Digito 1, espacio, Digito 2):  ";
            cin >> jugada2 >> jugada;
            cout << "\n\n";
        ...
        if (i == 1)
        {
            ...
            cout << "\n\n !!!Enhorabuena jugador " << --jugador << ", has ganado!!!\n";
        ...
        cout << "Para continuar pulsa 1, para terminar pulsa 0\n\n\t";
...
void tabla()  //Printea el tablero
{
    cout << endl << endl << "\t";
    cout << "      |      |      |     \n\t";
    cout << "  " << cuadricula2[1] << cuadricula[1] << "  |  " << cuadricula2[2] << cuadricula[2] << "  |  " << cuadricula2[3] << cuadricula[3] << "  |  " << cuadricula2[4] << cuadricula[4] << "  \n\t";
    cout << "______|______|______|______      ---------------------------\n\t";
    cout << "      |      |      |            |  Jugador 1 | Jugador 2  |\n\t";
    cout << "  " << cuadricula2[5] << cuadricula[5] << "  |  " << cuadricula2[6] << cuadricula[6] << "  |  " << cuadricula2[7] << cuadricula[7] << "  |  " << cuadricula2[8] << cuadricula[8] << "        |------------|------------|\n\t";
    cout << "______|______|______|______      |      " << j1 << "     |     " << j2 << "      |\n\t";
    cout << "      |      |      |            ---------------------------\n\t";
    cout << "  " << cuadricula2[9] << cuadricula[9] << "  |  " << cuadricula2[10] << cuadricula[10] << "  |  " << cuadricula2[11] << cuadricula[11] << "  |  " << cuadricula2[12] << cuadricula[12] << "  \n\t";
    cout << "______|______|______|______\n\t";
    cout << "      |      |      |       \n\t";
    cout << "  " << cuadricula2[13] << cuadricula[13] << "  |  " << cuadricula2[14] << cuadricula[14] << "  |  " << cuadricula2[15] << cuadricula[15] << "  |  " << cuadricula2[16] << cuadricula[16] << "  \n\t";
    cout << "      |      |      |     \n\n\n";
}
